...
CP2114_GetVersions(HID_UART_DEVICE device, BYTE* api_version, BYTE* fw_version);
...
HID_TO_UART_API HID_UART_STATUS WINAPI
CP2114_GetOtpConfig(HID_UART_DEVICE device, BYTE cp2114ConfigNumber, PCP2114_CONFIG_STRUCT pCP2114ConfigStruct);
